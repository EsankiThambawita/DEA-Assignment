  ...
  <div class="column">
    <div class="card">
        <a href="https://www.linkedin.com/in/imalsha-sandali-54b01326a">  
             <img src= "Images/Developers/sandali.jpg"  alt="E. L Thambawita" style="width:100%"></a>
            <div class="container">
  ...
  <div class="column">
    <div class="card">
        <a href="www.linkedin.com/in/oneli-wickramaratne">  
            <img src= "Images/Developers/oneli.jpg"  alt="E. L Thambawita" style="width:100%"></a>
            <div class="container">
...
<div class="row">
    <div class="column">
      <div class="card">
         ...
         <img src= "Images/Developers/Adeesha.jpg"  alt="E. L Thambawita" style="width:100%"></a>
        <div class="container">
