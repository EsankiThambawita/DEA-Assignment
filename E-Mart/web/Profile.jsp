    ...
    <div class="container">
        <div class="sidebar"><br>
            ...
            <div class="sidebar-item">
              ...
              <img src="Images/TrackOrderIcon.png" alt="MyReturns">
                <span>Track Current Orders</span>
                </a>
            </div>
            <div class="sidebar-item">
                <a href="OrderHistory.jsp">
              <img src="Images/OrderHistoryIcon.png" alt="MyReturns">
                <span>Order History</span>
                </a>
            </div>
            <div class="sidebar-item">
                 <a href="MyReturns.jsp">
                     <img src="Images/MyReturnsIcon.png" alt="MyReturns"><br>
        ...
        <div class="user-image-container">
                <img src="Images/ProfilePlaceholderIcon.png">
            </div>
